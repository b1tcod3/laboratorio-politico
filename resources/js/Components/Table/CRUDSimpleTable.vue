            ...
            <tbody>
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer" v-for="d in data">
                        ...
                        <td class="px-4 py-3 flex items-center justify-end">
                            ...
                            <Link :href="`${route}/${d['id']}`" class="block py-2 px-4">
                                <Icon name="eye" class="text-blue-800"/>
                            </Link>
                                  
                            <Link :href="`${route}/${d['id']}/edit`" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <Icon name="edit" class="text-green-500"/>
                            </Link>
