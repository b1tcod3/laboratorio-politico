<script setup>
  ...
  import EstructuraPsuvBaseFormCalle from '@/Pages/Estructura/Partials/EstructuraPsuvBaseFormCalle.vue';
...
const closeModal = () => {
  ...
  const fields = [{'id':1,'name_display':'ID','name':'id'},
        ...
        {'id':8,'name_display':'Cédula','name':'cedula'},
        {'id':9,'name_display':'Cargo','name':'cargo_nombre'},
        {'id':10,'name_display':'Nombre','name':'nombres'},
        {'id':11,'name_display':'Apellido','name':'apellidos'},
        {'id':12,'name_display':'Sexo','name':'sexo'},
        {'id':13,'name_display':'Teléfono','name':'telefono_movil'},
  ...
  const updateTable = (column) => {
      loading.value = true;
      form.get('/estructuras/CALLE', pickBy(form), { preserveState: true,
          onFinish: () => {
            loading.value=false;
          }
        })
...
<template>
  <div>
    ...
    <h1 class="mb-8 text-3xl font-bold">Estructura Política Calle</h1>
...
<Modal :show="showModal" @close="closeModal" >
       <EstructuraPsuvBaseFormCalle @closeModal="closeModal" :miembro="miembro" :cargos="cargos" :municipios="municipios" :municipio="form.municipio" :parroquias="parroquias" :parroquia="form.parroquia" :centros_electorales="centros_electorales" :centro_electoral="form.centro_electoral" :comunidades="comunidades" :comunidad="form.comunidad"
       :calles="calles" :calle="form.calle" />
</Modal>
