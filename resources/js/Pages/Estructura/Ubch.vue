...
const closeModal = () => {
  ...
  const fields = [{'id':1,'name_display':'ID','name':'id'},
        ...
        {'id':6,'name_display':'Cédula','name':'cedula'},
        {'id':7,'name_display':'Cargo','name':'cargo_nombre'},
        {'id':8,'name_display':'Nombre','name':'nombres'},
        {'id':9,'name_display':'Apellido','name':'apellidos'},
        {'id':10,'name_display':'Sexo','name':'sexo'},
        {'id':11,'name_display':'Teléfono','name':'telefono_movil'},
  ...
  const updateTable = (column) => {
      loading.value = true;
      form.get('/estructuras/UBCH', pickBy(form), { preserveState: true,
          onFinish: () => {
            loading.value=false;
          }
        })
...
<template>
  <div>
    <Head title="UBCH" />
    <h1 class="mb-8 text-3xl font-bold">Estructura Política UBCH</h1>
...
<div class="grid gap-6 mb-6 md:grid-cols-3">
  ...
  <SelectForm label="Municipio" v-model="form.municipio" :options="municipios" nameOption="nombre"
            :error="form.errors.municipio" @change="form.parroquia='';form.centro_electoral='';updateTable()"
            />
...
<Modal :show="showModal" @close="closeModal" >
       <EstructuraPsuvBaseForm @closeModal="closeModal" :miembro="miembro" :cargos="cargos" :municipios="municipios" :municipio="form.municipio" :parroquias="parroquias" :parroquia="form.parroquia" :centros_electorales="centros_electorales" :centro_electoral="form.centro_electoral"/>
</Modal>
