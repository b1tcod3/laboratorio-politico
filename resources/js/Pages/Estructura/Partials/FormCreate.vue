<script setup>
    ...
    import useMunicipios from '@/Composables/municipios.js';
    import useParroquias from '@/Composables/parroquias.js';

    const openModal = inject('openCreateModal');

    const { municipios, getMunicipios } = useMunicipios();
    const { parroquias, getParroquias } = useParroquias();
    ...
    const form = useForm('post', route('estructuras.store'), {
        nombre: '',
        nivel: '',
        organizacion_id: '',
        area: '',
        ...
        <div class="p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form @submit.prevent="create">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option :value="id" v-for="(nivel,id) in niveles_estructura">{{nivel.replace('_',' ')}}</option>
                        </select>
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"
                ...
                <div v-show="indexNivel>0">
                    ...
                    v-model="form.municipio_id" @change="getParroquias(form.municipio_id);"
                    >
                ...
                <div v-show="indexNivel>1">
                    ...
                    >
                        <option value="">Todos los Parroquia</option>
                ...
                <button v-show="isModal" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
