...
<template>
    ...
    <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        <dl class="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
            <div class="flex flex-col items-center justify-center">
                <dt class="mb-2 text-xl md:text-xl font-extrabold">{{centro_electoral.nombre}}</dt>
                <dd class="font-light text-gray-500 dark:text-gray-400">Nombre del Centro Electoral</dd>
            </div>
            <div class="flex flex-col items-center justify-center">
            ...
            <div class="flex flex-col items-center justify-center">
                <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{{comunidades.length}}</dt>
  ...
  <container-table name="comunidades" 
  >

  <template #headings>
   <tr>
    <th v-for="column in columnsTable.columns_comunidades">
  ...
  <template #rows>
    <tr v-for="comunidad in comunidades">
      <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{comunidad.id}}</td>
      <td>{{comunidad.comunidad_nombre}}</td>
      <td>sdd</td>
      <td><Link :href="route('comunidades.show',{comunidad:comunidad.id})">
        <Icon name="eye"/>
      </Link></td>
    </tr>
  </template>
...
<Link :href="route('comunidades.index')" 
