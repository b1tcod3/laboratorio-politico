...
import Logo from '@/Components/Icon/ApplicationLogo.vue';
import Icon from '@/Components/Icon/Icon.vue';
import Dropdown from '@/Components/Dropdown/DropdownMenu.vue'
import MainMenu from '@/Layouts/Partials/MainMenu.vue'
import FlashMessages from '@/Components/Alert/FlashMessages.vue'
    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-red-900 md:flex-shrink-0 md:justify-center md:w-56">
          ...
          <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
            <div class="mr-4 mt-1">{{ user.name }}</div>
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  ...
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="">Manage Users</Link>
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden flex-shrink-0 p-12 w-56 bg-red-800 overflow-y-auto md:block" />
